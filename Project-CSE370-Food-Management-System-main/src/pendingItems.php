                        ...
                        while ($row = mysqli_fetch_assoc($result)){
                            ...
                            ?>
                              <tr>
                                ...
                                <td><button onclick="handleStatus('<?php echo $itemID ?>','<?php echo $itemStatus ?>','reject')">reject</button>||<button onclick="handleStatus('<?php echo $itemID ?>','<?php echo $productStatus ?>','approve')">approve</button></td>
                              </tr>
                    <?php
                          }
                    }?>
